...
<!--[if gte IE 9]><!--><html class="no-js" lang="it"><!--<![endif]-->
...
<head>
  ...
  <meta name="HandheldFriendly" content="True">
	...
	<link rel="apple-touch-icon" sizes="114x114" href="/images/mobile/touch-icon-iphone.png" />
...
text-align:center;line-height:50px;">
  <div style="font-size:36px;">Simply make webservices<{$smarty.session.user.id}></div>
